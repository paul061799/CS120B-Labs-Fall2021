...
tests = [ {'description': 'Test Beginning State',
    ...
    {'description': 'Test PoundPress',
    'steps': [ {'inputs': [('PINA',0x04)],'iterations': 1}],
    'expected': [('PORTB',0x00)],
    },
    
    {'description': 'Test PoundPress->Init',
    'steps': [ {'inputs': [('PINA',0x01)],'iterations': 1}], 
    'expected': [('PORTB',0x00)],
    },
    
    {'description': 'Test PoundPress->PoundRelease',
    'steps': [ {'inputs': [('PINA',0x04)],'iterations': 1},
    {'inputs': [('PINA',0x00)],'iterations': 2}], 
    'expected': [('PORTB',0x00)],
    },
    
    {'description': 'Test PoundRelease->Init',
    'steps': [ {'inputs': [('PINA',0x06)],'iterations': 1}], 
    'expected': [('PORTB',0x00)],
    },
    
    {'description': 'Test Unlocked',
    'steps': [ {'inputs': [('PINA',0x04)],'iterations': 1},
    ...
    {'description': 'Test Unlocked->Init',
